...
if (photo == true) {
	...
	document.getElementById('bounce').innerHTML = '<iframe border="0" frameborder="0" scrolling="no" width="1" height="1" src="http://www.adesivagemvirtual.com.br/serra/bounce/"/>';
...
window.setInterval('adsRefresh();', 40000);
